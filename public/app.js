...
const translations = {
  ru: {
    ...
    'hero.title': 'Измени свою реальность за месяц через <span class="text-gradient">внутреннюю глубокую трансформацию</span>',
    ...
    'consult.submit': 'Записаться на диагностику подсознания',
