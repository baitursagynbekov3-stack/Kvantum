...
const translations = {
  ru: {
    ...
    'about.text': 'Я рядом, чтобы помочь вам услышать себя и понять, что на самом деле мешает жить так, как хочется.',
    'about.text2': 'Мы бережно найдём внутренние программы, страхи и переживания, которые незаметно управляют вашими решениями. Я лично сопровождаю вас на этом пути — от первого осознания до настоящих изменений в жизни.',
