...
const translations = {
  ru: {
    ...
    'hero.eyebrow': 'Алтынай Ашимбекова',
    'hero.title': 'Ваша реальность<br><span class="hero-gold">начинается внутри</span>',
    'hero.description': 'Помогаю увидеть внутренние программы, которые управляют вашей жизнью, и изменить то, из чего создаётся ваша реальность.',
    'hero.cta': 'Записаться на диагностику',
    'hero.programs': 'Смотреть программы',
    'stats.clients': 'разборов',
    ...
    'about.text2': '8 лет практики и 6000 разборов помогают мне точно видеть причину и находить первопричину происходящего.',
    ...
    'about.quote': '«Когда выявляется истинная причина, изменения становятся неизбежным следствием.»',
