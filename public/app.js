...
const translations = {
  ru: {
    ...
    'hero.title': 'Реальность<br><span class="hero-gold">начинается изнутри</span>',
    'hero.description': 'Пойми, куда утекает твоя энергия и почему реальность не меняется.',
    'hero.cta': 'Записаться на диагностику',
    'hero.programs': 'Смотреть программы',
    'stats.clients': 'проведённых разборов',
    'stats.satisfaction': 'клиентов прошли мои программы',
    'stats.years': 'лет практики',
    'stats.growth': 'Средний рост',
    'about.label': 'Обо мне',
    'about.title': 'Алтынай Эшинбекова — <span class="text-gradient">Ваш проводник к трансформации</span>',
    'about.text': 'Я помогаю увидеть внутренние программы, которые влияют на ваши деньги, отношения, состояние и реализацию — и выявить то, из чего создаётся ваша реальность.',
    'about.text1': 'Точечно выявляю, меняю деструктивные программы и внутренние сценарии, влияющие на вашу реальность.',
    'about.text2': 'Сопровождаю от хаоса к по-настоящему удовлетворённой жизни — через раскрытие внутреннего потенциала и расширение сознания.',
    ...
    'about.quote': '«Нахожу, куда утекает ваша энергия, помогаю увидеть первопричину происходящего и закрыть то, что удерживает вас в прошлом.»',
    'work.label': 'Что мы делаем',
    'work.title': 'Этапы <span class="text-gradient">работы</span>',
    'work.subtitle': 'У меня есть групповые и индивидуальные сессии.',
    'work.card1.title': 'Помогу сформировать настоящий запрос',
    'work.card1.desc': 'Я разбираю ситуацию, с которой вы пришли, и помогаю сформировать точный запрос. Потому что за желанием больше зарабатывать, построить отношения или изменить жизнь часто стоит более глубокое желание — чувствовать свободу, безопасность, признание, любовь, уверенность или внутреннюю опору.',
    'work.card2.title': 'Провожу глубокую диагностику',
    'work.card2.desc': 'Я исследую, как формировалась ваша сегодняшняя реальность: какие чувства, страхи, убеждения, автоматические программы и повторяющиеся сценарии продолжают влиять на ваши решения и состояние.',
    'work.card3.title': 'Нахожу первопричину и утечки энергии',
    'work.card3.desc': 'Я дохожу до того, что лежит в основе повторяющегося сценария. Определяю, где остаётся ваша энергия, каких внутренних ресурсов сегодня не хватает и что необходимо восстановить для движения к вашему запросу.',
    'work.card4.title': 'Определяю точку трансформации',
    'work.card4.desc': 'После диагностики становится понятно, куда именно нужно идти в работу. Я не пытаюсь разобрать всю жизнь человека — нахожу конкретную точку, связанную с сегодняшним запросом.',
    'work.card5.title': 'Точечная психологическая работа',
    'work.card5.desc': 'Работаю точечно, как хирург: нахожу конкретный участок, который требует внимания, не поднимая всю вашу историю. Трансформирую то, что связано с вашим запросом, и возвращаю освободившийся ресурс в настоящее.',
    'work.formula': 'Запрос → истинное желание → диагностика → первопричина → точечная трансформация → новая реальность',
    'services.title': 'Индивидуальные форматы работы со мной',
    'services.s1.title': 'Индивидуальная диагностика подсознания и внутреннего состояния',
    'services.s1.desc': 'Сначала мы вместе спокойно разбираемся, что у вас болит и чего вам на самом деле хочется: выясняем, что стоит за вашими целями, и находим причины, которые не дают получить желаемое. Смотрим, где внутри застряла энергия — усталость, страх или старые обиды, которые мешают двигаться. И находим, куда уходит ваша энергия, чтобы вернуть её себе.',
    'services.s2.title': 'Трансформационная сессия',
    'services.s2.desc': 'Трансформационная сессия — это точечная работа на уровне подсознания. Мы аккуратно находим и меняем старые программы и автоматические реакции, которые больше вам не помогают.',
    'services.s2.duration': 'Длительность: 2–3 часа.',
    'services.s2.price': 'Стоимость фиксирована, уточняйте у менеджеров.',
    'services.s3.title': 'Сопровождение к цели',
    'services.s3.desc': 'Сопровождение к цели — это работа на один, два или шесть месяцев. Раз в неделю мы встречаемся на полтора часа и точечно прорабатываем программы и реакции, которые мешают двигаться дальше. Параллельно я сопровождаю вас между сессиями, чтобы изменения закреплялись в реальных ситуациях и вы шли к своей цели с поддержкой.',
    'services.formula': 'Диагностика → трансформация → сопровождение к цели',
  ...
  en: {
    ...
    'nav.consult': 'Book a Diagnostic',
    'hero.badge': 'Subconscious & Quantum Field Work',
    'hero.eyebrow': 'Altynai Ashimbekova',
    'hero.title': 'Your reality<br><span class="hero-gold">begins within</span>',
    'hero.description': 'I help you see the inner programs that run your life, and change what your reality is built from.',
    'hero.cta': 'Book a Diagnostic',
    ...
    'about.text': 'I help you see the inner programs that shape your money, relationships, state, and self-realization — and uncover what your reality is truly made of.',
    'about.text2': '8 years of practice and 6,000 sessions help me pinpoint the true cause and find the root of what\'s happening.',
    ...
    'about.quote': '"When the true cause is revealed, change becomes the inevitable result."',
...
// Local fallback answers (Russian only, website-scoped)
var faqLocalAnswers = [
  { keywords: ['привет', 'здравствуй', 'добрый', 'hello', 'hi'], answer: 'Здравствуйте! Чем могу помочь? Спросите о программах, ценах или запишитесь на бесплатную консультацию.' },
  ...
  { keywords: ['результат', 'получу', 'чему научусь'], answer: 'Вы научитесь лучше понимать людей, уверенно общаться, управлять эмоциями и быстрее достигать желаемых результатов в жизни и работе.' },
  ...
  { keywords: ['цена', 'стоимость', 'сколько', 'прайс'], answer: 'Диагностика — 5 000 сом/мес, Интенсив «Папа, Мама», Перезагрузка и Наставничество — уточняйте у менеджеров.' },
  ...
  { keywords: ['интенсив', 'папа', 'мама', 'крыл'], answer: 'Интенсив «Папа, Мама — мои 2 крыла» — работа с родовыми и семейными сценариями: сепарация от рода, восстановление иерархии, закрытие детских обид. Стоимость уточняйте у менеджеров.' },
  { keywords: ['reboot', 'ребут', 'перезагрузка'], answer: 'Перезагрузка — 5 недель, 10 Zoom-встреч, записи сохраняются 3 месяца. Работа с финансами или отношениями. Стоимость уточняйте у менеджеров.' },
  ...
  { keywords: ['контакт', 'связ', 'whatsapp', 'telegram', 'телефон'], answer: 'Свяжитесь с нами через WhatsApp или Telegram — кнопки есть на сайте в разделе «Контакты».' },
  { keywords: ['алтынай', 'основатель', 'кто'], answer: 'Основатель КВАНТУМ — Алтынай Эшинбекова, специалист по работе с подсознанием, НЛП и квантовому полю.' },
  { keywords: ['оплат', 'карт', 'перевод'], answer: 'Оплата доступна через Stripe (карты), а также другие способы. Подробности уточняйте на консультации.' }
];
...
function getFaqLocalAnswer(msg) {
  ...
  return 'Пожалуйста, уточните вопрос или свяжитесь с нами через WhatsApp или Telegram.';
}
...
var serviceDetails = {
  1: {
    ru: {
      title: 'Формируем настоящий запрос',
      body: 'Я разбираю ситуацию, с которой вы пришли, и помогаю сформировать точный запрос. Потому что за желанием больше зарабатывать, построить отношения или изменить жизнь часто стоит более глубокое желание — чувствовать свободу, безопасность, признание, любовь, уверенность или внутреннюю опору.'
    },
    en: {
      title: 'Subconscious',
  ...
  2: {
    ru: {
      title: 'Проводим глубокую диагностику',
      body: 'Я исследую, как формировалась ваша сегодняшняя реальность: какие чувства, страхи, убеждения, автоматические программы и повторяющиеся сценарии продолжают влиять на ваши решения и состояние.'
    },
    en: {
      title: 'Energy Field',
  ...
  3: {
    ru: {
      title: 'Находим первопричину и утечки энергии',
      body: 'Я дохожу до того, что лежит в основе повторяющегося сценария. Определяю, где остаётся ваша энергия, каких внутренних ресурсов сегодня не хватает и что необходимо восстановить для движения к вашему запросу.'
    },
    en: {
      title: 'Leader State',
  ...
  4: {
    ru: {
      title: 'Определяем точку трансформации',
      body: 'После диагностики становится понятно, куда именно нужно идти в работу. Я не пытаюсь разобрать всю жизнь человека — нахожу конкретную точку, связанную с сегодняшним запросом.'
    },
    en: {
  ...
  5: {
    ru: {
      title: 'Точечная психологическая работа',
      body: 'По своему принципу она напоминает точную хирургию: сначала проводится диагностика, находится конкретный участок, который требует внимания, и только после этого начинается работа. Я не затрагиваю без необходимости всю вашу внутреннюю историю и не поднимаю всё прошлое. Я точечно работаю с конкретными ситуациями, чувствами и программами, связанными с вашим запросом, трансформирую их и возвращаю освободившийся ресурс в настоящее.'
    }
  }
};
...
function openServiceDetail(num) {
  ...
  if (!detail) return;
  var content = detail[lang] || detail.ru;
